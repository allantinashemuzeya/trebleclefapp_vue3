<template>
    ...
    <div class="row match-height">
        ...
        <div class="col-lg-3 col-md-12 col-sm-12" v-for="school in schools">

            <a href="">
                <div class="card card-congratulations" :style="{backgroundImage:`url(${school['banner']})`, backgroundSize: 'cover'}">
    ...
    <div class="d-inline-block" v-for="school in schools">
        <!-- Modal -->
